...
- (void)buildUI {
    ...
    for (int i = 0; i < number; i++) {
        ...
        [itemButton setTitleColor:[UIColor colorWithHexString:@"0x8fce47"] forState:UIControlStateSelected];
    ...
    [self setNeedsLayout];
    UIButton *btn=[[UIButton alloc]initWithFrame:CGRectMake(15, 5, 30, 30)];
    self.btn=btn;
    ...
    UIButton *pubbtn=[[UIButton alloc]initWithFrame:CGRectMake(kScreen_Width-65, 5, 50, 30)];
    self.pubbtn=pubbtn;
    ...
    [self.tabView addSubview:pubbtn];
}
-(void)searchClick{
...
- (UIView *)selectedLine {
    if (!_selectedLine) {
        ...
        _selectedLine.backgroundColor = [UIColor colorWithHexString:@"0x8fce47"];
